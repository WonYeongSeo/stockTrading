...
def trading_logging(stock, type, is_jump, msg) :
    ...
    if stock :
        if 'BUY' == type :
            __earn_rate = float(stock.earn_rate)
...
def file_copy() :
    ...
    # shutil.copy2(CONST_FILE_JUMP_LOG, CONST_FILE_PATH_BACKUP + __current_day + CONST_FILE_NAME_JUMP_LOG + CONST_FILE_EXTENSION)
    # shutil.copy2(CONST_FILE_JUMP_TRA_LOG, CONST_FILE_PATH_BACKUP + __current_day + CONST_FILE_NAME_JUMP_TRA_LOG + CONST_FILE_EXTENSION)
    shutil.copy2(CONST_FILE_RISE_LOG, CONST_FILE_PATH_BACKUP + __current_day + CONST_FILE_NAME_RISE_LOG + CONST_FILE_EXTENSION)
