...
# 급등주
CONST_JUMP_SLEEP_TIME = int(52) # 급등주 수행주기
CONST_JUMP_START_TIME = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 9, 3, 30) # 급등주 시작 시간

# 상승주
CONST_RISE_SLEEP_TIME = int(46) # 상승주 수행주기
CONST_RISE_BUY_DELAY_TIME = int(360) # 상승주 매수 대기 시간
CONST_RISE_START_TIME = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 9, 30, 30) # 상승주 시작 시간
