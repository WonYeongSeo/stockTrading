...
CONST_SELL_LOSS_RISE_RATE = float(-2) # 상승주 매도 손절율
...
# 상승주
CONST_RISE_SLEEP_TIME = int(3*55) # 상승주 수행주기
CONST_RISE_START_TIME = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 9, 13, 0) # 상승주 시작 시간
...
CONST_FILE_NAME_RISE_LOG = '상승주매매일지.txt'
CONST_FILE_NAME_RISE_TRA_LOG = '상승주검색종목리스트.txt'
CONST_FILE_RISE_LOG = CONST_FILE_PATH_LOG + CONST_FILE_NAME_RISE_LOG
CONST_FILE_RISE_TRA_LOG = CONST_FILE_PATH_LOG + CONST_FILE_NAME_RISE_TRA_LOG
CONST_FILE_ERROR_LOG = CONST_FILE_PATH_LOG + '에러로그.txt'
CONST_FILE_NAME_ANALYSIS_LOG = '분석용검색리스트.txt'
